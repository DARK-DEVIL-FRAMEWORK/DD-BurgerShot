...
RegisterServerEvent('DD-burgershot:givetoyburgershot')
AddEventHandler('DD-burgershot:givetoyburgershot', function(key)
    local src = source
...
QBCore.Functions.CreateCallback('DD-burgershot:itemcheck', function(source, cb, item)
...
RegisterNetEvent('DD-burgershot:server:bigcola', function()
    local src = source
...
RegisterNetEvent('DD-burgershot:server:smallcola', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('DD-burgershot:server:coffee', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('DD-burgershot:server:bigpotato', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('DD-burgershot:server:smallpotato', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('DD-burgershot:server:rings', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('DD-burgershot:server:nuggets', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('DD-burgershot:server:meat', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('DD-burgershot:server:bleederburger', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('DD-burgershot:server:bigkingburger', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    Player.Functions.RemoveItem(Config.Bread, 1)
    Player.Functions.RemoveItem(Config.Meat, 1)
...
RegisterNetEvent('DD-burgershot:server:wrap', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
---
RegisterNetEvent('DD-burgershot:server:chocolateicecream', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('DD-burgershot:server:vanillaicecream', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    Player.Functions.RemoveItem(Config.Cone, 1)
...
RegisterNetEvent('DD-burgershot:server:thesmurfsicecream', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    Player.Functions.RemoveItem(Config.Cone, 1)
...
RegisterNetEvent('DD-burgershot:server:strawberryicecream', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    Player.Functions.RemoveItem(Config.Cone, 1)
...
RegisterNetEvent('DD-burgershot:server:matchaicecream', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    Player.Functions.RemoveItem(Config.Cone, 1)
...
RegisterNetEvent('DD-burgershot:server:ubeicecream', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    Player.Functions.RemoveItem(Config.Cone, 1)
...
RegisterNetEvent('DD-burgershot:server:smurfetteicecream', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    Player.Functions.RemoveItem(Config.Cone, 1)
...
RegisterNetEvent('DD-burgershot:server:unicornicecream', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    Player.Functions.RemoveItem(Config.Cone, 1)
...
RegisterNetEvent('DD-burgershot:server:macaroon', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('DD-burgershot:server:sell-box', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('DD-burgershot:server:package')
AddEventHandler('DD-burgershot:server:package', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local info = {
        type = "menu",
...
function openPacket(source, item)
    ...
    for itemName, itemData in pairs(itemData.info.items) do
        TriggerEvent('DD-burgershot:givetoyburgershot')
...
Citizen.CreateThread(function()
    local resourceName = "^2 DD-burgershot Started ("..GetCurrentResourceName()..")"
    print("\n^1----------------------------------------------------------------------------------^7")
    print(resourceName)
    print("^1----------------------------------------------------------------------------------^7")
end)

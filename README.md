...
## Video Showcase
- https://youtu.be/Miw6wQ7OgQY
## Discord
- https://discord.gg/HF2whxGAeP
...
```
### ConsumablesEat
- Add the following code to your `DD-smallresources/config/ConsumablesEat`
...
### ConsumablesDrink
- Add the following code to your `DD-smallresources/config/ConsumablesDrink`
...
- Add the following code to your `DD-smallresources/server/consumables.lua`
